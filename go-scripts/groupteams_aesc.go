...
// producer, here the urls are generated and passed to the jobs channel
...
// As the names suggests, all the "ingredients" needed to process this request are passed in with the struct Result passed as an input channel with the value passed from the results variable
func worker(
    ctx context.Context,
    wg *sync.WaitGroup,
    client *http.Client,
